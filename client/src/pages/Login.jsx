    ...
    <div className="min-h-screen bg-dark-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="card border-gold/10 shadow-gold-lg relative overflow-hidden">
          ...
          <div className="bg-gold/5 border border-gold/20 rounded-lg px-4 py-3 mb-6">
            <p className="text-gold text-xs font-medium mb-1">Demo Credentials</p>
            <p className="text-gray-400 text-xs">admin@jbcrownstone.com  ·  admin123</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="login-email" className="block text-gray-400 text-xs mb-2 uppercase tracking-wider">
                Email Address
              </label>
              <input
                id="login-email"
            ...
            <div>
              <label htmlFor="login-password" className="block text-gray-400 text-xs mb-2 uppercase tracking-wider">
                Password
              </label>
              <input
                id="login-password"
